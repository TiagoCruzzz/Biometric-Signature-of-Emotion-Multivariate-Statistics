...
# Checking the data (Happy_features_S1_separated): 
# Happy_features_S1_separated contains the data associated with the features selected by methodology A and separated by physiological signal obtained during the happy stimuli
print(Happy_features_S1_separated[1:29,0:3])
print(dim(Happy_features_S1_separated))
baseline_data = Happy_features_S1_separated[1:29,2:44]
...
### Hierarchical method:
dendrogramadistancia=dist(df, method="euclidian") # Medida de aproximação, neste caso é usada a distância euclidiana 
