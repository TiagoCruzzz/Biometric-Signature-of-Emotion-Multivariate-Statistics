...
#-------------------------------------------------------------------------------
#Geral - EMG + EDA + ECG:
dados <- read_excel("C:\\Users\\tiago\\OneDrive\\Desktop\\Dissertação\\Análise Happy\\happy_features_excerpts_s1.xlsx", sheet = "Geral_EMG+EDA+ECG")
print(dados)
dadosG1<-dados[,-1]
...
#Geral - EMG
dados1_EMG <- read_excel("C:\\Users\\tiago\\OneDrive\\Desktop\\Dissertação\\Análise Happy\\happy_features_excerpts_s1.xlsx", sheet = "Geral_EMG")
print(dados1_EMG)
...
#Geral - EDA
dados1_EDA <- read_excel("C:\\Users\\tiago\\OneDrive\\Desktop\\Dissertação\\Análise Happy\\happy_features_excerpts_s1.xlsx", sheet = "Geral_EDA")
print(dados1_EDA)
...
#Geral - ECG
dados1_ECG <- read_excel("C:\\Users\\tiago\\OneDrive\\Desktop\\Dissertação\\Análise Happy\\happy_features_excerpts_s1.xlsx", sheet = "Geral_ECG")
print(dados1_ECG)
...
saveWorkbook(wb, file = "C:\\Users\\tiago\\OneDrive\\Desktop\\Dissertação\\Análise Happy\\features_happy_excerpts_geral\\resultados_pca_features_happy_Geral_EMG_EDA_ECG.xlsx", overwrite = TRUE)
...
ggsave("Geral_EMG_EDA_ECG_Variances_PCA_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_EDA_ECG_Variables_PCA_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_EDA_ECG_Contributions_to_pc1_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_EDA_ECG_Contributions_to_pc2_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_EDA_ECG_Contributions_to_pc3_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_EDA_ECG_Individuals_PCA_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_EDA_ECG_Biplot_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_EDA_ECG_Contributions_to_pc1+pc2_Happy.png",dpi = 300,bg = "white")
...
require(rgl)
png("Geral_EMG_EDA_ECG_3D_scatterplot_Happy.png",units="in",width=6,height=5,res=600)
s3d <- scatterplot3d(scores[,1:3],  pch = 16,grid=TRUE, box=TRUE,main="3D Scatter Plot (Geral - EMG+EDA+ECG features - Happy)", xlab=paste(" CP1  (", (round(100*sum.res2$importance[2,1],digits=1)), " % )"), ylab=paste(" CP2  (", (round(100*sum.res2$importance[2,2],digits=1)), " % )"), zlab=paste(" CP3  (", (round(100*sum.res2$importance[2,3],digits=1)), " % )"))
...
saveWorkbook(wb, file = "C:\\Users\\tiago\\OneDrive\\Desktop\\Dissertação\\Análise Happy\\features_happy_excerpts_geral\\resultados_pca_features_happy_Geral_EMG.xlsx", overwrite = TRUE)
...
p + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10))+ labs(title = "Variances - PCA",x = "Principal Components", y = "% of variances")+ theme(plot.title = element_text(hjust = 0.5)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EMG_Variances_PCA_Happy.png",dpi = 300,bg = "white")

# PCA Variables graph
fviz_pca_var(res2, col.var="contrib", gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE, labelsize = 2) + labs(title = "Variables - PCA") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EMG_Variables_PCA_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_Contributions_to_pc1_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_Contributions_to_pc2_Happy.png",dpi = 300,bg = "white")
...
ggsave("Geral_EMG_Contributions_to_pc3_Happy.png",dpi = 300,bg = "white")

# Extract the results for individuals
fviz_pca_ind(res2, col.ind = "cos2",gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),repel = TRUE ) + labs(title = "Individuals - PCA") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EMG_Individuals_PCA_Happy.png",dpi = 300,bg = "white")

# Biplot
fviz_pca_biplot(res2,col.var="contrib",gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE, labelsize = 2) + labs(title = "Biplot") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EMG_Biplot_Happy.png",dpi = 300,bg = "white")
...
var <- get_pca_var(res2)
corrplot(var$contrib, is.corr=FALSE) 
ggsave("Geral_EMG_Contributions_Happy.png",dpi = 300,bg = "white")

# Total contribution on PC1,PC2 and PC3:
fviz_contrib(res2, choice = "var", axes = 1:2, top =85, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC1 and PC2") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 5)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank()))
ggsave("Geral_EMG_Contributions_to_pc1+pc2_Happy.png",dpi = 300,bg = "white")
...
png("Geral_EMG_3D_scatterplot_Happy.png",units="in",width=6,height=5,res=600)
s3d <- scatterplot3d(scores[,1:3],  pch = 16,grid=TRUE, box=TRUE,main="3D Scatter Plot (Geral - EMG features - Happy)", xlab=paste(" CP1  (", (round(100*sum.res2$importance[2,1],digits=1)), " % )"), ylab=paste(" CP2  (", (round(100*sum.res2$importance[2,2],digits=1)), " % )"), zlab=paste(" CP3  (", (round(100*sum.res2$importance[2,3],digits=1)), " % )"))
text(s3d$xyz.convert(scores[, 1:3]), labels = rownames(scores),
     cex= 0.7, pos=3, col = "steelblue")
dev.off()
...
saveWorkbook(wb, file = "C:\\Users\\tiago\\OneDrive\\Desktop\\Dissertação\\Análise Happy\\features_happy_excerpts_geral\\resultados_pca_features_happy_Geral_EDA.xlsx", overwrite = TRUE)
...
p <- fviz_screeplot(res2, addlabels = TRUE, hjust = -0.3,  barfill="lightgray", barcolor ="black",linecolor ="red",  ylim = c(0, 60))
p + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10))+ labs(title = "Variances - PCA",x = "Principal Components", y = "% of variances")+ theme(plot.title = element_text(hjust = 0.5)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EDA_Variances_PCA_Happy.png",dpi = 300,bg = "white")

# PCA Variables graph
fviz_pca_var(res2, col.var="contrib", gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE, labelsize = 2) + labs(title = "Variables - PCA") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EDA_Variables_PCA_Happy.png",dpi = 300,bg = "white")

# Contributions of variables to PC1
#fviz_contrib(res2, choice = "var", axes = 1, top =50)
fviz_contrib(res2, choice="var", axes = 1, top=30, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC1") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 7)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EDA_Contributions_to_pc1_Happy.png",dpi = 300,bg = "white")

# Contributions of variables to PC2
fviz_contrib(res2, choice="var", axes = 2, top=30, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC2") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 7)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EDA_Contributions_to_pc2_Happy.png",dpi = 300,bg = "white")

# Contributions of variables to PC3
fviz_contrib(res2, choice="var", axes = 3, top=30, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC3") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 7)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EDA_Contributions_to_pc3_Happy.png",dpi = 300,bg = "white")

# Extract the results for individuals
fviz_pca_ind(res2, col.ind = "cos2",gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),repel = TRUE ) + labs(title = "Individuals - PCA") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EDA_Individuals_PCA_Happy.png",dpi = 300,bg = "white")

# Biplot
fviz_pca_biplot(res2,col.var="contrib",gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE, labelsize = 2) + labs(title = "Biplot") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_EDA_Biplot_Happy.png",dpi = 300,bg = "white")
...
var <- get_pca_var(res2)
corrplot(var$contrib, is.corr=FALSE) 
ggsave("Geral_EDA_Contributions_Happy.png",dpi = 300,bg = "white")

# Total contribution on PC1,PC2 and PC3:
fviz_contrib(res2, choice = "var", axes = 1:2, top =85, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC1 and PC2") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 5)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank()))
ggsave("Geral_EDA_Contributions_to_pc1+pc2_Happy.png",dpi = 300,bg = "white")
...
png("Geral_EDA_3D_scatterplot_Happy.png",units="in",width=6,height=5,res=600)
s3d <- scatterplot3d(scores[,1:3],  pch = 16,grid=TRUE, box=TRUE,main="3D Scatter Plot (Geral - EDA features - Happy)", xlab=paste(" CP1  (", (round(100*sum.res2$importance[2,1],digits=1)), " % )"), ylab=paste(" CP2  (", (round(100*sum.res2$importance[2,2],digits=1)), " % )"), zlab=paste(" CP3  (", (round(100*sum.res2$importance[2,3],digits=1)), " % )"))
text(s3d$xyz.convert(scores[, 1:3]), labels = rownames(scores),
     cex= 0.7, pos=3, col = "steelblue")
dev.off()
...
saveWorkbook(wb, file = "C:\\Users\\tiago\\OneDrive\\Desktop\\Dissertação\\Análise Happy\\features_happy_excerpts_geral\\resultados_pca_features_happy_Geral_ECG.xlsx", overwrite = TRUE)
...
p <- fviz_screeplot(res2, addlabels = TRUE, hjust = -0.3,  barfill="lightgray", barcolor ="black",linecolor ="red",  ylim = c(0, 60))
p + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10))+ labs(title = "Variances - PCA",x = "Principal Components", y = "% of variances")+ theme(plot.title = element_text(hjust = 0.5)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_ECG_Variances_PCA_Happy.png",dpi = 300,bg = "white")

# PCA Variables graph
fviz_pca_var(res2, col.var="contrib", gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE, labelsize = 2) + labs(title = "Variables - PCA") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_ECG_Variables_PCA_Happy.png",dpi = 300,bg = "white")

# Contributions of variables to PC1
#fviz_contrib(res2, choice = "var", axes = 1, top =50)
fviz_contrib(res2, choice="var", axes = 1, top=30, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC1") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 7)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_ECG_Contributions_to_pc1_Happy.png",dpi = 300,bg = "white")

# Contributions of variables to PC2
fviz_contrib(res2, choice="var", axes = 2, top=30, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC2") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 7)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_ECG_Contributions_to_pc2_Happy.png",dpi = 300,bg = "white")

# Contributions of variables to PC3
fviz_contrib(res2, choice="var", axes = 3, top=30, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC3") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 7)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_ECG_Contributions_to_pc3_Happy.png",dpi = 300,bg = "white")

# Extract the results for individuals
fviz_pca_ind(res2, col.ind = "cos2",gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"),repel = TRUE ) + labs(title = "Individuals - PCA") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_ECG_Individuals_PCA_Happy.png",dpi = 300,bg = "white")

# Biplot
fviz_pca_biplot(res2,col.var="contrib",gradient.cols = c("#00AFBB", "#E7B800", "#FC4E07"), repel = TRUE, labelsize = 2) + labs(title = "Biplot") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 10)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank())
ggsave("Geral_ECG_Biplot_Happy.png",dpi = 300,bg = "white")

# Highlight the most contributing variables for each dimension
library("corrplot")
var <- get_pca_var(res2)
corrplot(var$contrib, is.corr=FALSE) 
ggsave("Geral_ECG_Contributions_Happy.png",dpi = 300,bg = "white")

# Total contribution on PC1,PC2 and PC3:
fviz_contrib(res2, choice = "var", axes = 1:2, top =85, fill = "lightgray", color = "black")+ labs(title = "Contributions of variables to PC1 and PC2") + theme(plot.title = element_text(hjust = 0.5)) + theme(text = element_text(size = 13),axis.title = element_text(size = 13),axis.text = element_text(size = 5)) #+ theme(panel.grid.major = element_blank(),panel.grid.minor = element_blank()))
ggsave("Geral_ECG_Contributions_to_pc1+pc2_Happy.png",dpi = 300,bg = "white")
...
png("Geral_ECG_3D_scatterplot_Happy.png",units="in",width=6,height=5,res=600)
s3d <- scatterplot3d(scores[,1:3],  pch = 16,grid=TRUE, box=TRUE,main="3D Scatter Plot (Geral - ECG features - Happy)", xlab=paste(" CP1  (", (round(100*sum.res2$importance[2,1],digits=1)), " % )"), ylab=paste(" CP2  (", (round(100*sum.res2$importance[2,2],digits=1)), " % )"), zlab=paste(" CP3  (", (round(100*sum.res2$importance[2,3],digits=1)), " % )"))
text(s3d$xyz.convert(scores[, 1:3]), labels = rownames(scores),
     cex= 0.7, pos=3, col = "steelblue")
dev.off()
