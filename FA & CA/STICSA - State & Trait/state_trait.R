...
# Acessing and checking the data (state_R or trait_R):
print(state_R[1:5,1:5]) # or trait_R
df = subset(state_R, select = -c(X) )
print(df[1:5,1:5])
print(diag(var(df))) 
