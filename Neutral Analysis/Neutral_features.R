...
# Checking the data (Neutral_features_S1_separated): 
# Neutral_features_S1_separated contains the data associated with the features selected by methodology A and separated by physiological signal, obtained during the neutral stimuli
print(Neutral_features_S1_separated[1:29,0:3])
print(dim(Neutral_features_S1_separated))
baseline_data = Neutral_features_S1_separated[1:29,2:40]
